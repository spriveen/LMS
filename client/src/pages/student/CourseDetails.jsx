...
const CourseDetails = () => {
  ...
  const { allCourse, calculateRating, calculateNoOfLectures, calculateCourseDuration, calculateChapterTime, currency } = useContext(AppContext)
    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='text-sm'>
            Course by <span className='text-blue-600 underline'>Riveen</span>
          </p>
        ...
        {/* right column */}
        <div className='max-w-course-card z-0 shadow-custom-card rounded-t
              ...
              text-white font-medium'>{isAlreadyEnrolled ? 'AlreadyEnrolled':'Enroll Now'}</button>
               ...
               <div className='pt-6'>
                ...
                text-gray-500'>
                   ...
                   <li>Ste-by-step, hands-on project guidance</li>

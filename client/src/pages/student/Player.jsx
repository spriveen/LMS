...
const Player = () => {
  ...
  useEffect(() => {
    const found = enrolledCourse.find(course => course._id === courseId)
    setCourseData(found)
                          ...
                          <div className='flex gap-2'>
                            {lecture.lectureUrl && (
                              <button
                                ...
                                onClick={() => setPlayerData({ videoId: getYouTubeId(lecture.lectureUrl), lectureTitle: lecture.lectureTitle })}
                              >
                                Watch
                              </button>
                            )}

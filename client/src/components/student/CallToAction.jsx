...
const CallToAction = () => {
  return (
    ...
    px-8 md:px-0'>
        ...
        <p className='text-gray-500 sm:text-sm'> Unlock your potential with flexible learning that fits your schedule. Join thousands of learners gaining new skills from the comfort of their home.</p>
